const DEFAULT_INACTIVITY_TIMEOUT_MINUTES = 480;
...
export const AUTH_INACTIVITY_TIMEOUT_MS =
  parsePositiveNumber(import.meta.env.VITE_AUTH_INACTIVITY_TIMEOUT_MINUTES, DEFAULT_INACTIVITY_TIMEOUT_MINUTES) *
  60 *
  1000;
