...
const heroSlideSchema = z.object({
  ...
  titleTop: z.string().trim().max(160).nullish(),
  titleAccent: z.string().trim().max(160).nullish(),
  description: z.string().trim().max(500).nullish(),
  primaryLabel: z.string().trim().max(80).nullish(),
  primaryHref: z.string().trim().max(255).nullish(),
  secondaryLabel: z.string().trim().max(80).nullish(),
  secondaryHref: z.string().trim().max(255).nullish(),
  imageUrl: z.string().trim().max(2048).nullish(),
  overlayFrom: z.string().trim().max(64).nullish(),
  overlayVia: z.string().trim().max(64).nullish(),
  overlayTo: z.string().trim().max(64).nullish(),
  cardEyebrow: z.string().trim().max(120).nullish(),
  cardTitle: z.string().trim().max(180).nullish(),
  cardDescription: z.string().trim().max(400).nullish(),
});
