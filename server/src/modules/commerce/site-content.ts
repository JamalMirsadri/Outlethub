...
const heroSlideSchema = z.object({
  ...
  titleTop: z.string().trim().max(160),
  titleAccent: z.string().trim().max(160),
  description: z.string().trim().max(500),
  primaryLabel: z.string().trim().max(80),
  primaryHref: z.string().trim().max(255),
  secondaryLabel: z.string().trim().max(80),
  secondaryHref: z.string().trim().max(255),
  imageUrl: z.string().trim().max(2048),
  overlayFrom: z.string().trim().max(64),
  overlayVia: z.string().trim().max(64),
  overlayTo: z.string().trim().max(64),
  cardEyebrow: z.string().trim().max(120),
  cardTitle: z.string().trim().max(180),
  cardDescription: z.string().trim().max(400),
});
